...
- Update Paths: Add your image paths inside the python codes. Open both attendance.py and automaticAttendance.py, and change the file paths to match your system's setup.
